class Play extends Phaser.Scene {
    ...
    create() {
        ...
        keyO = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.S);
        keyA = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.N);
        keyW = this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.M);
